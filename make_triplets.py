...
if machine == 'local':
    ...
    output_dir = '/Users/abby/Documents/repos/tf_tripletloss/features'
else:
    ...
    output_dir = '/project/focus/abby/tf_tripletloss/features'
...
np.save(os.path.join(output_dir,'classes.npy'),allClasses)
np.save(os.path.join(output_dir,'ims.npy'),np.asarray(allIms))
np.save(os.path.join(output_dir,'classes_0_ind.npy'),classes_0_ind)
np.save(os.path.join(output_dir,'traffickcamOrExpedia.npy'),tcOrExpedia)
...
np.save(os.path.join(output_dir,'feats.npy'),allFeats)
