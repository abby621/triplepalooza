...
def combine_horz(images):
    new_im = np.zeros((images[0].shape[0],images[0].shape[1]*4,3))
    new_im[:images[0].shape[1],:images[0].shape[0],0] = images[0][:,:,2]
    new_im[:images[0].shape[1],:images[0].shape[0],1] = images[0][:,:,1]
    new_im[:images[0].shape[1],:images[0].shape[0],2] = images[0][:,:,0]
    new_im[:images[1].shape[1],images[1].shape[0]:images[1].shape[0]*2,0] = images[1][:,:,2]
    ...
    new_im[:images[3].shape[1],images[3].shape[0]*3:images[3].shape[0]*4,0] = images[3][:,:,2]
    new_im[:images[3].shape[1],images[3].shape[0]*3:images[3].shape[0]*4,1] = images[3][:,:,1]
    new_im[:images[3].shape[1],images[3].shape[0]*3:images[3].shape[0]*4,2] = images[3][:,:,0]
    return new_im
...
for label in reppedLabels:
    for idx in np.where(testingLabels==label)[0]:
        ...
        pil_out_im.save(os.path.join(hotel_outfolder,'%d_%d_%.2d.png'%(idx,cutOffInd)))
        print idx
