...
# If overfitting:
# python finetune_triplepalooza.py .3 50 128 .0001 True
# Else:
...
def main(margin,batch_size,output_size,learning_rate,is_overfitting):
    ...
    pretrained_net = './output/traffickcam/ckpts/checkpoint-201801101305_lr0pt0001_outputSz128_margin0pt3-24611'
    # pretrained_net = None
    img_size = [256, 256]
    crop_size = [224, 224]
    num_iters = 200000
