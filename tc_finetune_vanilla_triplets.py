# -*- coding: utf-8 -*-
"""
# python tc_finetune_vanilla_triplets.py margin batch_size output_size learning_rate whichGPU is_finetuning l1_weight bn_decay
# chop off last layer: python tc_finetune_vanilla_triplets.py .3 120 128 .0001 '3' True 0.05 0.9
# don't chop off last layer: python tc_finetune_vanilla_triplets.py .3 120 128 .0001 '3' False 0.05 0.9
"""
...
def main(margin,batch_size,output_size,learning_rate,whichGPU,is_finetuning,l1_weight,bn_decay):
    ...
    if batch_size%3 != 0:
        print 'Batch size must be divisible by 3!'
        sys.exit(0)

    # Create data "batcher"
    train_data = VanillaTripletSet(train_filename, mean_file, img_size, crop_size, batch_size, isTraining=is_training, isMixed=True)
