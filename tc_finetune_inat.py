# -*- coding: utf-8 -*-
"""
# python tc_finetune_inat.py margin batch_size output_size learning_rate whichGPU is_finetuning pretrained_net
# chop off last layer: python tc_finetune_inat.py .3 120 128 .0001 '3' True '/project/focus/abby/triplepalooza/models/ilsvrc-2012/resnet_v2_50.ckpt'
# don't chop off last layer: python tc_finetune_inat.py .3 120 128 .0001 '3' False '/project/focus/abby/triplepalooza/models/ilsvrc-2012/resnet_v2_50.ckpt'
"""

import tensorflow as tf
from classfile import iNatCombinatorialTripletSet
import os.path
import time
...
def main(margin,batch_size,output_size,learning_rate,whichGPU,is_finetuning,pretrained_net):
    ...
    ckpt_dir = './output/inat/ckpts'
    log_dir = './output/inat/logs'
    train_filename = './inputs/inat/train.txt'
    mean_file = './models/inat/meanIm.npy'
    ...
    # Create data "batcher"
    train_data = iNatCombinatorialTripletSet(train_filename, mean_file, img_size, crop_size, batch_size, num_pos_examples, isTraining=is_training)
    ...
    for step in range(num_iters):
        ...
        _, loss_val = sess.run([train_op, loss], feed_dict={image_batch: batch, same_user_batch: same_user_mask, label_batch: labels})
        end_time = time.time()
